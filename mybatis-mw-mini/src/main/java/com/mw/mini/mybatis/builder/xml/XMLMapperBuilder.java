...
import com.mw.mini.mybatis.builder.ResultMapResolver;
import com.mw.mini.mybatis.cache.Cache;
import com.mw.mini.mybatis.io.Resources;
import com.mw.mini.mybatis.mapping.ResultFlag;
...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    public void parse() throws Exception {
        ...
        if (!configuration.isResourceLoaded(resource)) {
            ...
            // 绑定映射器到namespace Mybatis 源码方法名 -> bindMapperForNamespace  （builderAssistant.getCurrentNamespace()-->com.xxx.UserMapper）
     ...
     * 解析mapper文件配置
     *
     * @param element eg：UserMapper.xml 根节点元素
     */
    private void configurationElement(Element element) {
        // 配置namespace
        String namespace = element.attributeValue("namespace");
        logger.info("ConfigurationElement Namespace:{}", namespace);
    ...
    /**
     * <resultMap id="activityMap" type="com.mw.mini.mybatis.test.po.Activity">
