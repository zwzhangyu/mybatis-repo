...
/**
 * 解析并存储 SQL 查询中的参数表达式
 * 例如：MyBatis 中的 #{} 语法。它继承自 HashMap<String, String>，
 * 用来存储解析后的表达式的各个部分（如 property, javaType, jdbcType 等）。
 * @author zhangyu
 */
public class ParameterExpression extends HashMap<String, String> {

    private static final long serialVersionUID = -3415552194343158680L;
